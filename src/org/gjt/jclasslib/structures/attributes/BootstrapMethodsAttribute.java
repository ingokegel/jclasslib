...
public class BootstrapMethodsAttribute extends AttributeInfo {
    ...
    /**
        Get the list of bootstrap method references in the <tt>ClassFile</tt> structure
    ...
    /**
        Set the list of bootstrap method references in the <tt>ClassFile</tt> structure
        as an array of <tt>BootstrapMethodsEntry</tt> structures.
